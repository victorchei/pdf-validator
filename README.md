...
**👉 ПОЧНІТЬ ЗВІДСИ:** [Гайд для нового розробника](./docs/NEW_DEVELOPER_GUIDE.md)

Детальна інструкція як:
- Налаштувати проект з нуля
- Встановити автоматизацію versions.json
- Створювати нові версії
- Розуміти як працює CI/CD
...
| Документ                                         | Опис                                            |
| ------------------------------------------------ | ----------------------------------------------- |
| [🆕 **Новий розробник**](./docs/NEW_DEVELOPER_GUIDE.md) | **START HERE!** Швидкий старт для новачків |
